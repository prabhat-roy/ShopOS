...
![Version: 26.1.2](https://img.shields.io/badge/Version-26.1.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v26.1.1](https://img.shields.io/badge/AppVersion-v26.1.1-informational?style=flat-square)

This page describes the official Redpanda Helm Chart. In particular, this page describes the contents of the chartâ€™s [`values.yaml` file](https://github.com/redpanda-data/helm-charts/blob/main/charts/redpanda/chart/values.yaml). Each of the settings is listed and described on this page, along with any default values.

For instructions on how to install and use the chart, including how to override and customize the chartâ€™s values, refer to the [deployment documentation](https://docs.redpanda.com/docs/deploy/deployment-option/self-hosted/kubernetes/kubernetes-deploy/).
