pipeline {
    ...
    parameters {
        ...
        booleanParam(name: 'HARBOR',        defaultValue: true,  description: 'Harbor — enterprise container registry')
        ...
        booleanParam(name: 'KRAKEN',        defaultValue: true,  description: 'Kraken — P2P Docker registry')
        booleanParam(name: 'DRAGONFLY',     defaultValue: true,  description: 'Dragonfly — P2P image distribution')
        booleanParam(name: 'NEXUS',         defaultValue: true,  description: 'Nexus — universal artifact repository')
        booleanParam(name: 'PULP',          defaultValue: true,  description: 'Pulp — on-prem package management')
        booleanParam(name: 'GITEA',         defaultValue: true,  description: 'Gitea — lightweight self-hosted Git')
        booleanParam(name: 'FORGEJO',       defaultValue: true,  description: 'Forgejo — community-driven Gitea fork')
        booleanParam(name: 'GOGS',          defaultValue: true,  description: 'Gogs — minimal self-hosted Git')
        booleanParam(name: 'GITBUCKET',     defaultValue: true,  description: 'GitBucket — GitHub-compatible Git platform')
        ...
        booleanParam(name: 'CHARTMUSEUM',   defaultValue: true,  description: 'ChartMuseum — Helm chart repository')
        booleanParam(name: 'TERRAREG',      defaultValue: true,  description: 'Terrareg — Terraform module registry')
        booleanParam(name: 'VERDACCIO',     defaultValue: true,  description: 'Verdaccio — npm/yarn private registry')
        booleanParam(name: 'CNPMJS',        defaultValue: true,  description: 'Cnpmjs — npm private registry')
        booleanParam(name: 'PYPISERVER',    defaultValue: true,  description: 'Pypiserver — minimal PyPI server')
        booleanParam(name: 'DEVPI',         defaultValue: true,  description: 'Devpi — full-featured PyPI server')
        ...
        booleanParam(name: 'REPOSILITE',    defaultValue: true,  description: 'Reposilite — lightweight Maven/Gradle repo')
        ...
        booleanParam(name: 'APTLY',         defaultValue: true,  description: 'Aptly — Debian/Ubuntu apt repository')
    }
