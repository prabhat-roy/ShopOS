{{/*
ShopOS — referral-service Helm helper templates
*/}}
...
helm.sh/chart: {{ include "referral-service.chart" . }}
{{ include "referral-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app: {{ include "referral-service.name" . }}
