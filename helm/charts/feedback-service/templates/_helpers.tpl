{{/*
ShopOS — feedback-service Helm helper templates
*/}}
...
{{- define "feedback-service.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "feedback-service.labels" -}}
helm.sh/chart: {{ include "feedback-service.chart" . }}
{{ include "feedback-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
