...
import (
	...
	"github.com/shopos/tax-reporting-service/internal/config"
...
func main() {
	logger := log.New(os.Stdout, "[tax-reporting] ", log.LstdFlags|log.Lmsgprefix)
	...
	fmt.Println("tax-reporting-service stopped")
}
