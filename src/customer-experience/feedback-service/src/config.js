...
module.exports = {
  HTTP_PORT: parseInt(process.env.HTTP_PORT || '8410', 10),
  GRPC_PORT: parseInt(process.env.GRPC_PORT || '50182', 10),
  DATABASE_URL: process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/feedback_db',
