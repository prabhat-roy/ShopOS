...
module.exports = {
  HTTP_PORT: parseInt(process.env.HTTP_PORT || '8408', 10),
  GRPC_PORT: parseInt(process.env.GRPC_PORT || '50127', 10),
  DATABASE_URL: process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/consent_db',
