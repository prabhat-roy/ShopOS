...
N/A â€” the Mobile BFF is a synchronous aggregation service and does not interact with Kafka directly.
...
- `push-notification-service` (communications) â€” device token registration
- `recommendation-service` (analytics-ai) â€” personalised feed

Downstream (services that call this):
- `api-gateway` (platform) â€” routes mobile client traffic here
