...
graph TB
    ...
    %% ── FRONTENDS ─────────────────────────────────────────────
    subgraph FE["🖥️  Frontend Applications  (6 apps)"]
        direction LR
        FE1["Next.js 14\nStorefront\n:3000"]:::frontend
        FE2["React + Vite\nAdmin Dashboard\n:3001"]:::frontend
        FE3["Vue.js 3\nSeller Portal\n:3002"]:::frontend
    ...
    %% ── PLATFORM SERVICES ─────────────────────────────────────
    subgraph PLAT["⚙️  Platform Services  (27)"]
        direction LR
    ...
    %% ── BUSINESS DOMAINS ──────────────────────────────────────
    subgraph DOM["🏢  Business Domain Services  (197 services across 18 domains)"]
        direction TB

        subgraph D1["🔐 Identity (11)"]
            direction LR
            D1A["auth-service\nRust · :50060"]:::domain
            D1B["user-service\nJava · :50061"]:::domain
            D1C["session-service\nGo · Redis"]:::domain
        ...
        subgraph D6["🎯 Customer Experience (17)"]
            direction LR
        ...
        subgraph D7["📨 Communications (12)"]
            direction LR
            D7A["email-service\nPython · Kafka"]:::domain
            D7B["sms · push · whatsapp\ntelegram · chatbot\n+ 7 more"]:::domain
        end

        subgraph D8["🖼️ Content (9)"]
            direction LR
            D8A["media-asset\nGo · MinIO"]:::domain
            D8B["cms-service\nNode.js · MongoDB"]:::domain
            D8C["video · document\ni18n · sitemap\n+ 5 more"]:::domain
        ...
        subgraph D12["Other Domains (30)"]
            direction LR
            D12A["🤝 Affiliate (6)"]:::domain
            D12B["🛍️ Marketplace (8)"]:::domain
            D12C["🎮 Gamification (6)"]:::domain
            D12D["🔧 Dev Platform (6)"]:::domain
            D12E["📋 Compliance (5)"]:::domain
            D12F["🌱 Sustainability (5)"]:::domain
        end
    end
    ...
    %% ── DATA STORES ───────────────────────────────────────────
    subgraph DS["🗄️  Data Stores  (13 engines)"]
        direction LR
        PG["PostgreSQL 16\nPatroni HA\n3-node cluster"]:::data
        MG["MongoDB 8.0\nCatalog · CMS\nReviews"]:::data
        RD["Redis 7\n+ Dragonfly\nCache · Sessions"]:::data
...
graph LR
    ...
    subgraph SCANNING["🔍  Scanning & SBOM"]
        TRIVY["Trivy\nContainer CVEs"]:::scan
...
graph TB
    ...
    subgraph COLLECT["🔄  Collection & Aggregation"]
...
graph LR
    ...
    subgraph GITOPS["🔄  GitOps Controllers"]
    ...
    subgraph DEPLOY["🚀  Progressive Delivery"]
        ROLLOUT["Argo Rollouts\nCanary deploys\nAll 19 domains"]:::deploy
        FLAGGER["Flagger\nBlue-green\nA/B testing"]:::deploy
    end

    subgraph K8S["☸️  Kubernetes Targets"]
        EKS["AWS EKS\nAuto Mode"]:::k8s
        GKE["Google GKE"]:::k8s
        AKS["Azure AKS"]:::k8s
    end
...
graph TB
    ...
    subgraph DEVTOOLS["🛠️  Developer Experience"]
        SKAFFOLD["Skaffold\nHot-reload\nLocal dev"]:::dev
        TILT["Tiltfile\nLocal K8s\nHot-reload"]:::dev
