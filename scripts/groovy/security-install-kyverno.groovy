def call() {
    ...
    sh "echo 'KYVERNO_WEBHOOK_URL=https://kyverno-svc.kyverno.svc.cluster.local:443' >> infra.env"
    sh "echo 'KYVERNO_METRICS_URL=http://kyverno-svc-metrics.kyverno.svc.cluster.local:8000' >> infra.env"
