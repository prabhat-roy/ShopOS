def call() {
    ...
    sh "echo 'NGINX_INGRESS_URL=http://nginx-ingress-ingress-nginx-controller.ingress-nginx.svc.cluster.local:80' >> infra.env"
    sh "echo 'NGINX_INGRESS_CLASS=nginx' >> infra.env"
