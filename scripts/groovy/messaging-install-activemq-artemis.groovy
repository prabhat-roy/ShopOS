def call() {
    ...
    sh "echo 'ACTIVEMQ_URL=tcp://activemq-artemis.activemq-artemis.svc.cluster.local:61616' >> infra.env"
    sh "echo 'ACTIVEMQ_CONSOLE_URL=http://activemq-artemis.activemq-artemis.svc.cluster.local:8161' >> infra.env"
