def call() {
    ...
    sh "sed -i '/^KUBE_STATE_METRICS_URL=/d' infra.env 2>/dev/null || true; echo 'KUBE_STATE_METRICS_URL=http://kube-state-metrics-kube-state-metrics.kube-state-metrics.svc.cluster.local:8080' >> infra.env" 
